...
export namespace jsbolo {
    ...
    interface IClientMessage {
        ...
        remoteView?: (jsbolo.IRemoteViewMessage|null);
    }
    ...
    class ClientMessage implements IClientMessage {
        ...
        /** ClientMessage remoteView. */
        public remoteView?: (jsbolo.IRemoteViewMessage|null);

        /** ClientMessage payload. */
        public payload?: ("input"|"chat"|"remoteView");
    ...
    /** Represents a RemoteViewMessage. */
    class RemoteViewMessage implements IRemoteViewMessage {

        /**
         * Constructs a new RemoteViewMessage.
         * @param [properties] Properties to set
         */
        constructor(properties?: jsbolo.IRemoteViewMessage);

        /** RemoteViewMessage pillboxId. */
        public pillboxId?: (number|null);

        /**
         * Creates a new RemoteViewMessage instance using the specified properties.
         * @param [properties] Properties to set
         * @returns RemoteViewMessage instance
         */
        public static create(properties?: jsbolo.IRemoteViewMessage): jsbolo.RemoteViewMessage;

        /**
         * Encodes the specified RemoteViewMessage message. Does not implicitly {@link jsbolo.RemoteViewMessage.verify|verify} messages.
         * @param message RemoteViewMessage message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: jsbolo.IRemoteViewMessage, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: jsbolo.IRemoteViewMessage, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a RemoteViewMessage message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns RemoteViewMessage
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): jsbolo.RemoteViewMessage;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): jsbolo.RemoteViewMessage;
         ...
         * @returns RemoteViewMessage
         */
        public static fromObject(object: { [k: string]: any }): jsbolo.RemoteViewMessage;

        /**
         * Creates a plain object from a RemoteViewMessage message. Also converts values to other types if specified.
         * @param message RemoteViewMessage
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: jsbolo.RemoteViewMessage, options?: $protobuf.IConversionOptions): { [k: string]: any };
